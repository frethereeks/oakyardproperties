    ...
    return (
        <section className='relative py-14 md:py-24 px-4 bg-dark rounded-[2%] text-white shadow-xl shadow-dark/20'>
            <div className="container mx-auto grid sm:grid-cols-2 md:grid-cols-3 gap-5 justify-center">
                {
                    [
                        [823497230, <AiOutlineIdcard key={823497231} className="text-inherit" />, "Mission", "To provide exceptional services and quality products to our clients and to follow through on our promises, while we strive to deliver individualized solutions to our client's housing needs and add value to their lives without compromise."],
                        [823497232, <AiFillCompass key={823497233} className="text-inherit" />, "Vision", "Our vision is to attain the height of being the leading real estate property company in the country and beyond. We consistently move to develop collaborations and partnerships, based on transparency and mutual trust, which serves to build enduring client relationships."],
