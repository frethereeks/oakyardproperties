    ...
    <footer className='relative py-20 px-4 bg-dark'>
      ...
      <div className="container mx-auto relative grid sm:grid-cols-2 md:grid-cols-3 gap-6 md:gap-10 text-white">
        <aside className="flex flex-col gap-6">
          <h1 className="text-2xl md:text-3xl font-extrabold">Chesres<span className='text-yell'>.</span></h1>
          ...
          <Link href={"https://goo.gl/maps/wZGLU81Aq68uT18c91"} className='bg-yell hover:bg-white hover:text-yell py-2 px-6 text-white rounded-sm w-max'>Directions</Link>
        </aside>
