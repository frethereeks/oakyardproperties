                ...
                <div className="flex flex-col gap-4">
                    <div className="flex flex-col gap-2 pb-10">
                        <div data-aos-duration="1500" data-aos-delay="1000" data-aos="fade-down">
                            <Header2 className='md:max-w-lg font-bold'>Find your Dream Home</Header2>
                        </div>
                    ...
                    <div data-aos-duration="1500" data-aos-delay="1800" data-aos="zoom-out-right" className="relative flex-1 min-h-64 lg:min-h-96 overflow-hidden rounded-sm">
                        <Image src={ASSETS_URL["oakyard_gallery3"]} alt="oakyard_gallery3" className='object-cover' fill />
                    </div>
                </div>
                <div className="flex flex-col gap-4">
                    <div data-aos-duration="1500" data-aos-delay="2200" data-aos="zoom-out-down" className="relative h-64 lg:h-96 overflow-hidden rounded-sm">
                        <Image src={ASSETS_URL["oakyard_gallery2"]} alt="oakyard_gallery2" className='object-cover' fill />
                    </div>
                    <div data-aos-duration="1500" data-aos-delay="2800" data-aos="zoom-out-left" className="relative h-40 lg:h-56 overflow-hidden rounded-sm">
                        <Image src={ASSETS_URL["oakyard_gallery1"]} alt="oakyard_gallery1" className='object-cover' fill />
                    </div>
                </div>
            </div>
        </section>
