      ...
      <section className="bg-dark py-10 relative">
        ...
        <div className="relative container mx-auto flex flex-col gap-10 px-4">
          <div className="flex justify-between items-center gap-4 flex-wrap py-16">
            <Header2 data-aos-duration="1000" data-aos-delay="1000" data-aos="fade-up" className="font-bold max-w-lg text-white text-3xl md:text-4xl">Solution. Collaboration. Innovation.</Header2>
        ...
        <div className="container mx-auto relative flex flex-col-reverse md:flex-row gap-6">
          <div className="flex-1 flex flex-col justify-center items-center py-10 md:pt-20">
            <div className="flex flex-col justify-center gap-2 md:gap-3 max-w-screen-sm text-white">
              <div data-aos-duration="1000" data-aos-delay="1000" data-aos="fade-left" className="bg-slate-100 p-1.5 pl-8 pr-6 rounded-full w-max mx-auto">
              ...
              <div data-aos-duration="1000" data-aos-delay="1500" data-aos="fade-left">
              ...
              <div data-aos-duration="1000" data-aos-delay="2000" data-aos="fade-right">
                <Para2 className="text-sitetext/70 text-center text-base pt-4 pb-2">We are a full-service, privately held commercial and residential real estate company. As a full business, we have the ability to rapidly move for any property from acquiring, financing, leasing, management and to maintenance.</Para2>
              </div>
              <Link data-aos-duration="1000" data-aos-delay="2500" data-aos="fade-up" href={appRoutePaths.properties} className="group bg-primary text-white hover:translate-y-1 transition-all duration-300 rounded-lg w-max py-2 px-6 text-sm md:text-base font-medium mx-auto">Check out our Properties</Link>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto grid sm:grid-cols-2 md:grid-cols-3 gap-5 justify-center">
          {
            [
              ...
              <figure data-aos-duration="1000" data-aos-delay={`${i === 0 ? '600' : i === 1 ? '800' : '1000'}`} data-aos={`${i === 0 ? 'fade-right' : i === 1 ? 'fade-down' : 'fade-up'}`} key={id.toString()} className={`flex flex-col gap-3 bg-white rounded-lg p-4 max-w-[24rem] mx-auto my-5`}>
