import { FeaturedSection, HappyClientSection, MissionVisionSection, StrategicSection } from '@/components'
  ...
  return (
    <main className='flex flex-col '>
      <section className="relative px-4 bg-blue/5 after:absolute after:h-12 after:w-full after:z-40 after:bg-[#ebf6fe] after:left-0 after:bottom-0 after:border-primary">
        {/* <video playsInline src={ASSETS_URL["oakyard_properties_prototype_video"]} width={'100%'} autoPlay muted loop controls disablePictureInPicture></video> */}
        <video autoPlay muted loop controls disablePictureInPicture playsInline poster={ASSETS_URL["DC240124_8"]} className="w-full h-full absolute top-0 left-0 object-cover">
